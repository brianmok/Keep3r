...
#ifdef WIN32
			Sleep(milliSecsPerNote - (noteEndTime - noteStartTime));			//milliseconds
#else
			usleep(1000*(milliSecsPerNote - (noteEndTime - noteStartTime))); 	//microseconds
#endif
		}
	}
